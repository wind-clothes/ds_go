...
func TestCounts(t *testing.T) {
	...
	n := rn.GetCount(99)
	t.Logf("success TestCounts JunkServer.Handler2 : %v", n)
	if n != 17 {
...
func TestConcurrentMany(t *testing.T) {
	...
	t.Logf("success TestConcurrentMany JunkServer.Handler2 : %v", n)
	if n != total {
...
func TestUnreliable(t *testing.T) {
	...
	t.Logf("success TestUnreliable JunkServer.Handler2 : %v", total)
