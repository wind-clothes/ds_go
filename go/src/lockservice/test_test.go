...
func tl(t *testing.T, ck *LockClient, lockname string, expected bool) {
	x := ck.Lock(lockname)
	if x != expected {
...
func tu(t *testing.T, ck *LockClient, lockname string, expected bool) {
...
func TestPrimaryFail2(t *testing.T) {
	...
	ck1 := MakeLockClient(phost, bhost)
	ck2 := MakeLockClient(phost, bhost)
